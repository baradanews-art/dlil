        ...
        <main class="flex-1 overflow-x-hidden">
            ...
            <div class="bg-white border-b border-slate-200 px-6 py-4 sticky top-0 z-30 shadow-sm">
                <div class="flex justify-between items-center flex-wrap gap-3">
                    <div>
                        <h1 class="text-xl font-black text-slate-900">@yield('page_heading')</h1>
                        <p class="text-xs text-slate-500 mt-0.5">@yield('page_subheading', 'لوحة تحكم دليل سوريا التجاري')</p>
                    </div>
                    <div class="flex items-center gap-3">
                        ...
                        <div class="relative group">
                            <button class="flex items-center gap-2 bg-slate-100 hover:bg-slate-200 rounded-xl px-3 py-2 transition-all">
                                ...
                                <span class="text-sm font-bold text-slate-700 hidden md:block">{{ Auth::user()->name ?? 'المدير' }}</span>
