...
class Business extends Model
{
    ...
    {
        $defaultLogoPath = public_path('uploads/logos/omar.png');
        if (file_exists($defaultLogoPath)) {
            return asset('uploads/logos/omar.png');
        }
    ...
    {
        $defaultCoverPath = public_path('uploads/logos/omar.jpg');
        if (file_exists($defaultCoverPath)) {
            return asset('uploads/logos/omar.jpg');
        }
