...
class OfficialEntityController extends Controller
{
    ...
    public function create()
    {
        ...
        $regions = collect(); // 🔥 فارغة في البداية
        
        return view('admin.official.create', compact('type', 'cities', 'regions'));
    }
    ...
    public function edit($id)
    {
        ...
        // 🔥 جلب المناطق المرتبطة بالمحافظة المختارة
        $regions = $entity->city_id ? Location::where('parent_id', $entity->city_id)->orderBy('name')->get() : collect();
    ...
    {
        $regions = Location::where('parent_id', $cityId)->orderBy('name')->get(['id', 'name']);
